...
const addBook = () => {
  ...
  const inputAuthor = document.getElementById("writer").value;
...
const makeBook = (title, author, year, isCompleted) => {
  ...
  if (isCompleted) {
    image.setAttribute("src", "img/Buku sudah dibaca.jpg");
  } else {
    image.setAttribute("src", "img/Buku belum dibaca.jpg");
  }
